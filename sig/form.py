...
from wtforms import (StringField, PasswordField, SubmitField, TextAreaField, IntegerField, DecimalField, EmailField, TelField, SearchField, DateField, SelectField, TimeField, validators)
...
class cadClientes(FlaskForm):
    ...
    enviar = SubmitField('Enviar', render_kw={"onclick" : "alert('Seja bem vinda ao grupo!!!')"})
...
class cadCompras(FlaskForm):
    ...
    enviar = SubmitField('Enviar', render_kw={"onclick" : "alert('Compra Realizada.!!!')"})
...
class vendaProduto(FlaskForm):
    ...
    enviar = SubmitField('Enviar', render_kw={"onclick" : "alert('Venda Realizada.!!!')"})
...
class formPessoal(FlaskForm):
    ...
    enviar = SubmitField('Enviar', render_kw={"onclick" : "alert('Colaborador Incluso no Banco de Dados.!!!')"})
...
class formAnaminese(FlaskForm):
    ...
    enviar = SubmitField('Enviar', render_kw={"onclick" : "alert('Ficha de Anaminese registrada.!!!')"})
...
class formRelatorioMEI(FlaskForm):
    ...
    enviar = SubmitField('Enviar', render_kw={"onclick" : "alert('Relatório MEI arquivado.!!!')"})
...
class formImpostos(FlaskForm):   
    ...
    enviar = SubmitField('Enviar', render_kw={"onclick" : "alert('Custos Mensais arquivado.!!!')"})
...
class formInsumos(FlaskForm):
    ...
    enviar = SubmitField('Enviar', render_kw={"onclick" : "alert('Calculando...')"})
...
class formDelete(FlaskForm):
      delete = SubmitField('Enviar', render_kw={"onclick" : "confirm('Deseja deletar?')"})
